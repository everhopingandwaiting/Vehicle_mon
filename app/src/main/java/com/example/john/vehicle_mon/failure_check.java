...
//        char ch[] = new char[]{0, 0, 0, 0, 0, 0, 0, 0};
            ...
            if ('0'==(ch[5])) {
                ...
                contral_stat_value_fc.setText("错误");
                contral_stat_value_fc.setTextColor(Color.RED);
            }
            if ('0'==(ch[6])) {
            ...
            if ('0'==(ch[7])) {
                ...
                power_driven_stat_value.setTextColor(Color.RED);
                power_driven_stat_value.setText("错误");
            }
